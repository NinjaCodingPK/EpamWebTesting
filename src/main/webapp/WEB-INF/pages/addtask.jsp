...
<html>
    ...
    <body>
        <div style="border-style:solid; background-color:#428bca; margin: auto;" id="header">
            <div>
                <h2 style="text-align: center; font-size: 3.8vw;">Task creation</h2>
            </div>
        </div>
                    ...
                    <div class="container-fluid space-top-lg">
                        <form action = "./Controller" method="POST" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Text of Question</label>
                                <div class="col-sm-8">
                                    <input type="text" name="question" class="form-control" value="${task.text}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Toughness</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label" >Right Answer</label>
                                <div class="col-sm-8">
