...
<html>
    ...
    <body>
        <div style="border-style:solid; background-color:#428bca; margin: auto;" id="header">
            <div>
                <h2 style="text-align: center; font-size: 3.8vw;">Welcome text</h2>
            </div>
        </div>
        ...
        <div id="main" class="container" style="border-style: solid; width: 60%; float: left">
            <h3 style="font-size: 2.8vw;">Info</h3>
            <h5 style="font-size: 1.5vw;">Name: ${user.name}</h5>
            <h5 style="font-size: 1.5vw;">Surname: ${user.surname}</h5>
            <hr color="black" style="float: none; width: 100%"/>
            <h5 style="font-size: 1.5vw;">Login: ${user.login}</h5>
            <h5 style="font-size: 1.5vw;">Rights: ${user.rights.name}</h5>
        </div>
    </body>
</html>
